...
public class UserDevfilePermissionsFilterTest {
  ...
  public Object[][] pathsProvider() {
    return new Object[][] {
      ...
      {"/workspace/workspace123/command/run-application", "delete", UserDevfileDomain.CONFIGURE},
      ...
      {"/workspace/workspace123/environment/myEnvironment", "delete", UserDevfileDomain.CONFIGURE},
