...
public interface MachineConfig {
    ...
    /**
     * Name of the attribute which if present defines memory limit of
    ...
    /**
     * Name of the attribute which if present defines requested memory
    ...
    /**
     * Name of the attribute which if present defines CPU limit of the
     * machine in cores.
     */
    String CPU_LIMIT_ATTRIBUTE = "cpuLimitCores";

    /**
     * Name of the attribute which if present defines requested CPU
     * allocation of the machine in cores.
     */
    String CPU_REQUEST_ATTRIBUTE = "cpuRequestCores";

    /**
     * Name of the attribute which, if present, defines the entrypoint
    ...
    /**
     * Name of the attribute which, if present, defines the command line
    ...
    /**
     * Name of the attribute which, if present, defines the alias of the
